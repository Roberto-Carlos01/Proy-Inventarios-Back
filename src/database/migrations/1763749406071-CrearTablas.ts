...
export class CrearTablas1763749406071 implements MigrationInterface {
  name = 'CrearTablas1763749406071';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "permission" ("id" SERIAL NOT NULL, "action" character varying, "subject" character varying, "detalle" character varying, CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
